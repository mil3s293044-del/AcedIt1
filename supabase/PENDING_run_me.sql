...
-- ════════════════════════════════════════════════════════════════════════════
-- 0037: The special lines — versus, cohort, longshot and prep.
--
-- Extends the market kind constraint and adds the indexes the board reads
-- through. Safe to run twice, and safe to run on a database that already has
-- 0036. Without it, minting a head-to-head or a cohort line fails the check
-- constraint and the board simply never gains the questions.
-- ════════════════════════════════════════════════════════════════════════════
