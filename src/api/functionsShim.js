...
export const getLeagueStanding         = makeFn('getLeagueStanding');
export const getMarkets                = makeFn('getMarkets');
export const takePosition              = makeFn('takePosition');
export const openMarkMarket            = makeFn('openMarkMarket');
export const reportMark                = makeFn('reportMark');
export const setLeagueAnonymity        = makeFn('setLeagueAnonymity');
