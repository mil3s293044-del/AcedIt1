...
export const SEASON_RANKS = [
    { name: "Bronze I",     minXP: 0,      maxXP: 1200,   tier: 1,  gradient: "from-amber-700 to-yellow-800",             color: "#92400e", division: "Bronze"   },
    { name: "Bronze II",    minXP: 1200,   maxXP: 2800,   tier: 2,  gradient: "from-amber-600 to-yellow-700",             color: "#b45309", division: "Bronze"   },
    { name: "Bronze III",   minXP: 2800,   maxXP: 5000,   tier: 3,  gradient: "from-amber-500 to-yellow-600",             color: "#d97706", division: "Bronze"   },
    { name: "Silver I",     minXP: 5000,   maxXP: 9000,   tier: 4,  gradient: "from-slate-400 to-gray-500",               color: "#6b7280", division: "Silver"   },
    { name: "Silver II",    minXP: 9000,   maxXP: 15000,  tier: 5,  gradient: "from-slate-300 to-gray-400",               color: "#9ca3af", division: "Silver"   },
    { name: "Silver III",   minXP: 15000,  maxXP: 24000,  tier: 6,  gradient: "from-gray-300 to-slate-300",               color: "#d1d5db", division: "Silver"   },
    { name: "Gold I",       minXP: 24000,  maxXP: 38000,  tier: 7,  gradient: "from-yellow-400 to-amber-500",             color: "#f59e0b", division: "Gold"     },
    { name: "Gold II",      minXP: 38000,  maxXP: 58000,  tier: 8,  gradient: "from-yellow-300 to-amber-400",             color: "#fbbf24", division: "Gold"     },
    { name: "Gold III",     minXP: 58000,  maxXP: 85000,  tier: 9,  gradient: "from-yellow-200 to-amber-300",             color: "#fde68a", division: "Gold"     },
    { name: "Platinum I",   minXP: 85000,  maxXP: 120000, tier: 10, gradient: "from-cyan-400 to-teal-500",                color: "#0891b2", division: "Platinum" },
    { name: "Platinum II",  minXP: 120000, maxXP: 170000, tier: 11, gradient: "from-cyan-300 to-teal-400",                color: "#22d3ee", division: "Platinum" },
    { name: "Platinum III", minXP: 170000, maxXP: 240000, tier: 12, gradient: "from-cyan-200 to-sky-300",                 color: "#7dd3fc", division: "Platinum" },
    { name: "Diamond I",    minXP: 240000, maxXP: 330000, tier: 13, gradient: "from-violet-400 to-purple-500",            color: "#8b5cf6", division: "Diamond"  },
    { name: "Diamond II",   minXP: 330000, maxXP: 440000, tier: 14, gradient: "from-violet-300 to-purple-400",            color: "#a78bfa", division: "Diamond"  },
    { name: "Diamond III",  minXP: 440000, maxXP: 600000, tier: 15, gradient: "from-fuchsia-400 to-violet-500",           color: "#c084fc", division: "Diamond"  },
    { name: "Elite",        minXP: 600000, maxXP: 800000, tier: 16, gradient: "from-rose-500 to-pink-600",                color: "#f43f5e", division: "Elite"    },
    { name: "Legend",       minXP: 800000, maxXP: Infinity, tier: 17, gradient: "from-yellow-400 via-rose-500 to-fuchsia-600", color: "#fbbf24", division: "Legend" },
];
