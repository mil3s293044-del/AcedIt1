    ...
    return (
        <Card className="bg-surface/70 dark:bg-slate-800/50 backdrop-blur-sm border-border/50 dark:border-slate-700/50">
            ...
            <CardContent className="space-y-4">
                 <div>
                    <p className="text-sm text-muted-foreground dark:text-muted-foreground/60">Email</p>
                    <p className="font-semibold text-lg">{user?.email}</p>
                </div>
                 <div>
                    <p className="text-sm text-muted-foreground dark:text-muted-foreground/60">Password</p>
