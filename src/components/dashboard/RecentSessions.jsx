                            ...
                            {recentSessions.map((session, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-4 p-3 rounded-lg hover:bg-secondary/30 transition-colors duration-200"
                                    >
                                        <div className="w-10 h-10 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center">
                                            <TechniqueIcon className="w-5 h-5 text-muted-foreground" />
                                        </div>
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <Badge 
                                                    variant="secondary" 
                                                    className={`text-xs ${techniqueColors[session.technique] || 'bg-secondary text-foreground'}`}
                                                >
